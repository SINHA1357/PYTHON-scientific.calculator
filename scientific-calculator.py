...
root.title("Scientific Calculator from @SINHA1357") 
...
lblDisplay = Label(calc, text="Scientific Calculator",
				font=('Algerian', 0, 'bold'),
				bg='pink', fg='black', justify=CENTER)
